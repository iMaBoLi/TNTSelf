...
CATEGORYS = {
    ...
    "Usage": ["Youtube", "Cover File", "Video Shot", "Trim Video", "Trim Audio", "Rotater", "Shazam", "Search Music", "Extract Audio", "Edit Duration", "Music Info"],
    ...
    "Groups": ["Ban", "Kick", "Mute", "Chat Info", "Search", "Delete Msg", "Welcome", "GoodBy", "Comment", "Auto Join", "Auto Leave", "Invite VC", "Channel Sign"],
